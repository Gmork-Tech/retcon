...
-- Deployment 1: Canary
INSERT INTO Deployment (priority, incrementDelay, incrementPercentage, incrementQuantity, initialPercentage, initialQuantity, shouldIncrement, targetPercentage, targetQuantity, targetHosts, applicationId, kind, name)
VALUES (1, 30000000000, 20, 10, 50, 100, true, 80, 150, null, '123e4567-e89b-12d3-a456-426655440000', 'BY_QUANTITY', 'Deployment 1'),
       (1, 30000000000, 30, 20, 20, 200, true, 60, 300, null, '123e4567-e89b-12d3-a456-426655440000', 'BY_PERCENTAGE', 'Deployment 2'),
