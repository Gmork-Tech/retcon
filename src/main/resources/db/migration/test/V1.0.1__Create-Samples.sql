...
-- Deployment 1: Canary
INSERT INTO Deployment (priority, incrementDelay, incrementPercentage, incrementQuantity, initialPercentage, initialQuantity, shouldIncrement, targetPercentage, targetQuantity, applicationId, kind, name)
VALUES (1, 300000000000, 20, 10, 50, 100, true, 80, 150, '123e4567-e89b-12d3-a456-426655440000', 'BY_QUANTITY', 'Deployment 1'),
       (1, 300000000000, 30, 20, 20, 200, true, 60, 300, '123e4567-e89b-12d3-a456-426655440000', 'MANUAL', 'Deployment 2'),
       (1, 300000000000, 40, 30, 10, 400, true, 40, 600, '123e4567-e89b-12d3-a456-426655440000', 'FULL', 'Deployment 3');
